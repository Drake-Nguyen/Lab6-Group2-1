...
static void test_id (void) {
   ...
   test (procedure_IDs, "apple,banana", {{"Identifier", "apple"}, {"Separator", ","}, {"Identifier", "banana"}}, CURRENT_LOCATION);
   ...
   test_fail (procedure_IDs, "    ", {}, CURRENT_LOCATION);
   test_fail (procedure_IDs, "class", {{"Keyword", "class"}}, CURRENT_LOCATION);
   test_fail (procedure_IDs, "", {}, CURRENT_LOCATION);
