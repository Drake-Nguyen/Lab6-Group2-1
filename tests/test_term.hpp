...
static void test_term(void) {
  ...
  test(procedure_Term, "2*y",
       {{"Integer", "2"}, {"Operator", "*"}, {"Identifier", "y"}},
       CURRENT_LOCATION);
  test(procedure_Term, "3*z/4",
       {{"Integer", "3"},
        {"Operator", "*"},
        {"Identifier", "z"},
        {"Operator", "/"},
  ...
  test(procedure_Term, "3zz z / 4",
       {{"Invalid Token", "3zz"},
        ...
        {"Integer", "4"}},
       CURRENT_LOCATION);
  test(procedure_Term, "2.5*x",
       {{"Real", "2.5"}, {"Operator", "*"}, {"Identifier", "x"}},
       CURRENT_LOCATION);
  test(procedure_Term, "1.23*(y+z)",
       {{"Real", "1.23"},
        {"Operator", "*"},
        {"Separator", "("},
        {"Identifier", "y"},
