...
static void test_print(void) {
  test(procedure_Scan, "put(a);", {{"Function", "print"}, {"Seperator", "("}, {"Identifier", "a"}, {"Seperator", ")"}, {"Seperator", ";"}}, CURRENT_LOCATION);
  test(procedure_Scan, "put(a,b);", {{"Function", "print"}, {"Seperator", "("}, {"Identifier", "a"}, 
