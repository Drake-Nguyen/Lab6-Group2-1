...
static void test_print(void) {
  test(procedureScan, "put(a);", {{"Function", "print"}, {"Seperator", "("}, {"Identifier", "a"}, {"Seperator", ")"}, {"Seperator", ";"}}, CURRENT_LOCATION);
  test(procedureScan, "put(a,b);", {{"Function", "print"}, {"Seperator", "("}, {"Identifier", "a"}, 
