...
static void test_primary(void)
{
    ...
    test(procedurePrimary, "Temp integer", {{"Identifier", "Temp"}, {"Other Separators", " "}, {"Identifier", "integer"}}, CURRENT_LOCATION);
    test(procedurePrimary, "temp+i", {{"Identifier", "temp"}, {"Operator", "+"}, {"Identifier", "i"}}, CURRENT_LOCATION);
    test(procedurePrimary, "", {}, CURRENT_LOCATION);
    test(procedurePrimary, "3.14", {{"Real", "3.14"}}, CURRENT_LOCATION);
    test(procedurePrimary, "6.0222331231123146546", {{"Real", "6.0222331231123146546"}}, CURRENT_LOCATION);
