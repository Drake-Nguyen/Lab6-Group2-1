...
test(procedurePrimary, "Temp integer", {{"Identifier", "Temp"}, 
{"Other Separators", " "}, {"Identifier", "integer"}}, CURRENT_LOCATION);
test(procedurePrimary, "temp+i", {{"Identifier", "temp"}, {"Operator", "+"}, 
{"Identifier", "i"}}, CURRENT_LOCATION);
test(procedurePrimary, "", {}, CURRENT_LOCATION);
